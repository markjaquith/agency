 ...
 */
export async function getGitConfig(key: string, gitRoot: string): Promise<string | null> {
  try {
 ...
 */
export async function setGitConfig(key: string, value: string, gitRoot: string): Promise<void> {
